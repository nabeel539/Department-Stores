        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-3">
            <input
              ...
              type="text"
              className="border border-gray-300 rounded-lg py-2 px-4 w-full focus:outline-none focus:ring focus:ring-red-200 text-sm"
        ...
        <div className="mt-4">
          ...
          <div className="w-full">
            ...
            <select
              ...
              value={paymentMethod}
              className="mt-2 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-700 shadow-sm focus:border-green-500 focus:ring-green-500"
            >
          ...
          <div className="w-full text-end mt-8">
            <button
              type="submit"
              className="inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-green-500 to-green-700 py-3 px-16 text-sm font-medium text-white shadow-lg hover:from-green-600 hover:to-green-800 focus:outline-none focus:ring-4 focus:ring-green-300"
            >
              PLACE ORDER
            </button>
          </div>
