...
const Login = () => {
  ...
  return (
    <div className="w-full flex justify-between gap-9 my-32">
      <img src={assets.slide2} className="w-1/2 my-auto h-[90%]" />
      <div className="w-1/2">
        <form
        ...
        >
          ...
          {currentState === "Login" ? (
            ...
            <input
              type="text"
              className="w-full px-3 py-2 border border-gray-800 rounded-[12px]"
              placeholder="Name"
              value={name}
          ...
          <button
            type="submit"
            className="bg-black text-white font-light px-8 py-2 mt-2 rounded-[12px]"
          >
